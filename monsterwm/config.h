 ...
 */
static const char *rofi1[] = {"launcher.sh", NULL};
static const char *rofi2[] = {"apps.sh", NULL};
static const char *rofi3[] = {"powermenu.sh", NULL};
...
static Key keys[] = {
    ...
    {  CONTROL,          XK_l,          spawn,             {.com = rofi1}},
    {  CONTROL,          XK_p,          spawn,             {.com = rofi3}},
    {  CONTROL,          XK_a,          spawn,             {.com = rofi2}},
    {  CONTROL,		 XK_j,		spawn,		   {.com = brw}},
